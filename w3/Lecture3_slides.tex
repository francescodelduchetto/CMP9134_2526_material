...
\setbeamertemplate{headline}{
    \begin{beamercolorbox}[wd=\paperwidth,ht=2.5ex,dp=1ex,right]{section in head/foot}
        ...
        \ifnum\insertframenumber<30
            \raisebox{-1pt}[0pt][0pt]{\normalsize\textbf{Attendance Code: 874231}}
        \fi
        \hspace{0.5cm}
    \end{beamercolorbox}
}
...
\begin{frame}
    \frametitle{Recap: Agile Methodologies}
    Last week, we explored the shift from traditional, linear development (Waterfall) to \textbf{iterative and incremental} Agile processes.
    
    

% [Image of Agile software development cycle]

    
    \begin{block}{The Agile Mindset}
        \begin{itemize}
...
\begin{frame}
    \frametitle{Recap: Scrum \& Solo Agile}
    We also looked at \textbf{Scrum}, a specific Agile framework, and how to adapt it for your individual Assessment 1 project.
...
% [Image of Scrum÷ framework process]
    ...
    \begin{itemize}
        \item \textbf{Sprints:} Working in short, focused iterations (e.g., 1-2 weeks).
        \item \textbf{Artifacts:} Maintaining a \textbf{Product Backlog} (everything needed) and a \textbf{Sprint Backlog} (what you are doing now).
        \item \textbf{Solo Agile ("Personal Scrum"):} You act as the \textit{Product Owner} (prioritising tasks), the \textit{Scrum Master} (managing your Trello board and removing distractions), and the \textit{Developer} (writing the code).
    \end{itemize}
\end{frame}
%------------------------------------------------------------
...
\begin{frame}
    ...
    \begin{itemize}
        \item \textbf{General Data Protection Regulation (GDPR) (EU,UK) / California Consumer Privacy Act (CCPA) (California):} Governs the protection of personal data. Design constraints imposed:
        \begin{itemize}
        ...
        \end{itemize}
        \item \textbf{Health Insurance Portability and acccountability Act HIPAA (US Health) / Payment Card Industry Data Security Standard PCI DSS (Payments):} Requires strict encryption, access controls (RBAC), and vulnerability scanning.
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]
    ...
    \textbf{WCAG: Web Content Accessibility Guidelines.}\\Accessibility ensures software is usable by all people, including those with disabilities. The W3C defines \textbf{POUR} principles:
    ...
    \tiny \url{https://www.w3.org/TR/UNDERSTANDING-WCAG20/intro.html} by World Wide Web Consortium (W3C)
\end{frame}
...
\begin{frame}
    \frametitle{Example: Accidental Dual Use}
    \centering
        \includegraphics[width=0.8\textwidth]{imgs/Screenshot 2026-02-20 at 08.55.26.png}
...
\begin{frame}
    ...
    \vspace{0.5cm}
    \footnotesize \url{https://www.atlassian.com/agile/product-management/prioritization-framework} for more details on prioritization frameworks.
\end{frame}
...
\begin{frame}
    ...
    \vspace{0.5cm}
    \footnotesize \url{https://www.atlassian.com/blog/agile/agile-design-prototypes} for more on prototyping in Agile.
    \url{https://en.wikipedia.org/wiki/Traceability_matrix} for more on traceability matrices.
\end{frame}
...
\begin{frame}[fragile]
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item The "Move" button must be accessible via Keyboard (WCAG).
        \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        \item \textbf{This Week's Workshop:} Requirements and LEPSI Constraints.
        % \item \textbf{Reading:} Sommerville, \textit{Software Engineering 9th Edition}, Chapter 1.
        \item \textbf{Next Week:} Software Modelling \& OOP.
    \end{itemize}
\end{frame}
