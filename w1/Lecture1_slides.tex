...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item \textbf{BlackBoard:} 
            \begin{itemize}
                \item Use the Discussion Board for questions regarding material or logistics.
                \item Use the Continuous Module Feedback for providing feedback/suggestions/praise/requests.
            \end{itemize}
        \item Don't be shy to ask questions during lectures or workshops!
