...
\begin{frame}[fragile]
    ...
    \begin{columns}
        \column{0.5\textwidth}
        \begin{itemize}
            \item \textbf{Actors:} Roles played by human users or external hardware (stick figures).
...
\begin{frame}
    ...
    \begin{tikzpicture}[
        ...
        \node[usecase] (coupon) at (2.75, -3) {Apply Coupon};
        \node[usecase] (pay)    at (2.75, -5) {Process Payment};
...
\begin{frame}
    ...
    Show the step-by-step interactions between actors and system components over time.
...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[
        ...
        \node[activity, minimum height=4.5cm] (act_d) at (7.5,-5.25) {};
        ...
        % Alt Box
        \draw[draw=black, thick] (-0.5, -5) rectangle (9, -7.2);
        \node[draw=black, fill=white, thick, anchor=north west] at (-0.5, -5) {\textbf{Alt}};
        \draw[dashed, thick] (-0.5, -6.1) -- (9, -6.1);
...
\begin{frame}
    \frametitle{Sequence Diagram Components}
    \small
...
\begin{frame}[fragile]
    ...
    \begin{tikzpicture}[
        ...
        \node[align=center, font=\scriptsize, below=0.3cm of company.east] {Composition:\\Team cannot exist\\without company};
        \node[align=center, font=\scriptsize, below=0.3cm of team.east] {Aggregation:\\Throw away team,\\employee still exists};
    \end{tikzpicture}
\end{frame}
