...
\begin{enumerate}
    ...
    \item \textbf{Daily Stand-up (Morning Routine -- you don't have to literally do it every day!):}
...
%% Add a box with text to highlight the importance of follwoing the process week by week, taking screenshots and records of the trello board, github issues and branches, so that they can demonstrate their process in the final report.
\vspace{0.5cm}
\noindent \textbf{\textcolor{red}{Important:} \textit{Make sure to follow this process week by week, taking screenshots and records of your Trello board, GitHub issues and branches, and any other tools you use. This documentation is crucial for demonstrating your process in the final report.}}
