...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \item \textbf{Evaluate} advanced deployment strategies (Blue/Green, Canary Releases).
        \item \textbf{Decouple} deployment from release using Feature Flags.
    \end{enumerate}
\end{frame}
...
\begin{frame}
    ...
    \vspace{0.3cm}
    We solve this through \textbf{Versioning} and \textbf{Git Tags}.
\end{frame}
...
\begin{frame}
    ...
    \begin{tikzpicture}[
        ...
        \node[box, draw=green!70!black, fill=green!10] (strat) at (8, 0) {Deploy\\Strategies};
        \node[box, draw=purple!70, fill=purple!10] (ff)  at (4, -2.2) {Feature Flags\\(Deploy $\neq$ Release)};
...
\begin{frame}
    \frametitle{Next Lecture: LEPSI, Security \& Professional Practice}
    \begin{block}{What is LEPSI?}
        The \textbf{Legislation, Ethics, Privacy, Security, and IP} framework that every software engineer is legally and professionally obligated to understand before shipping real software.
    \end{block}

    \vspace{0.3cm}
    We will cover:
    \begin{itemize}
        \item GDPR and data protection obligations for your GCS.
        \item Secure coding practices and common vulnerabilities (OWASP Top 10).
        \item Intellectual property: open-source licences and what you can legally ship.
        \item Professional codes of conduct (BCS).
    \end{itemize}

    \vspace{0.2cm}
    \textit{Think about: does your Ground Control Station store any personal or location data? What are your obligations?}
\end{frame}
