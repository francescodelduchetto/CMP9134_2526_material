...
\begin{enumerate}
    ...
    \item Write a brief section (1-2 paragraphs) declaring your chosen tech stack and mapping it to an architectural pattern.
...
\begin{itemize}
    \item \textbf{Python OOP for Beginners (Real Python):} \href{https://realpython.com/python3-object-oriented-programming/}{realpython.com/python3-object-oriented-programming/} - \textit{A fantastic, easy-to-read guide on how to create classes and objects in Python.}
